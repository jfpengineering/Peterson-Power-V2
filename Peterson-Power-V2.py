...
sleep(.1)
int_first_num = num
int_second_num = num+1
int_third_num = num+2
first_num = str(int_first_num)
second_num = str(int_second_num)
third_num = str(int_third_num)
replace_line("/etc/login.defs", first_num, "PASS_MAX_DAYS	15\n")
sleep(.1)
replace_line("/etc/login.defs", second_num, "PASS_MIN_DAYS	7\n")
sleep(.1)
replace_line("/etc/login.defs", third_num, "PASS_WARN_AGE	8\n")
sleep(.1)
